...
const WarehouseDetails = (routerProps) => {
	const id = routerProps.match.warehouseId;
...
// 	id = this.props.match.warehouseId;

// 	fetchData = () => {
// 		axios.get(GET_SINGLE_WAREHOUSE_API_URL(this.id)).then((response) => {
